...
public class ReadReaderCommand : ReaderActions, IReadReaderCommand
{
    public ReadReaderCommand(IReaderRepository readerRepository, ICreateReaderRequestValidator validator, IReaderMapper mapper)
