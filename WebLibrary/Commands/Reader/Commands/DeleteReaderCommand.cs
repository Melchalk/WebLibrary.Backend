...
public class DeleteReaderCommand : ReaderActions, IDeleteReaderCommand
{
    public DeleteReaderCommand(IReaderRepository readerRepository, ICreateReaderRequestValidator validator, IReaderMapper mapper)
