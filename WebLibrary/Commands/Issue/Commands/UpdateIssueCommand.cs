...
public class UpdateIssueCommand : IssueActions, IUpdateIssueCommand
{
    public UpdateIssueCommand(IIssueRepository issueRepository, ICreateIssueRequestValidator validator, IIssueMapper mapper)
